...
def add():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            cur.execute("INSERT INTO purchases (seller, product_name, product_type, product_quantity, unit_price, total_cost, date, user_id) VALUES (seller, product_name, product_type, product_quantity, unit_price, total_cost, 1);")
